...
export default {
  ...
  methods: {
    ...
    async listUsers() {
      ...
      const response = await fetch(`${process.env.VUE_APP_API_URL}/users/liststaffs?authfilter=customersupport&fullnamefilter=${this.search}&page=${this.pagination.page}&limit=${this.pagination.limit}`, {
        method: 'GET',
        headers: {
          "Content-Type": "application/json"
        },
