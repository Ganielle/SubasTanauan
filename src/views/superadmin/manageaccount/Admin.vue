...
export default {
  ...
  methods: {
    ...
    async listUsers() {
      ...
      const response = await fetch(`http://localhost:5000/users/liststaffs?authfilter=admin&fullnamefilter=${this.search}&page=${this.pagination.page}&limit=${this.pagination.limit}`, {
        method: 'GET',
        headers: {
          "Content-Type": "application/json"
        },
