<template>
  <div
    class="relative flex flex-col min-w-0 break-words bg-white rounded mb-6 xl:mb-0 shadow-lg" style="margin-bottom: 10px;"
  >
    <div class="flex-auto p-4">
      ...
      <p class="text-sm text-blueGray-400 mt-4" :hidden="subStatsHidden">
